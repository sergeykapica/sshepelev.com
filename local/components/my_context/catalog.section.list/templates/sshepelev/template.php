...
<?if(count($arResult['SECTIONS']) > 0):?>
    ...
    <?
    if($arParams['VIEW_MODE'] == 'LINE')
    {
        foreach ($arResult['SECTIONS'] as &$arSection)
        {
        ?>
            <section class="section-list-item">
                <a href="<?=$arSection['SECTION_PAGE_URL'];?>" class="section-list-url">
                    <div class="list-item-icon"></div>
                    <div class="list-item-name"><?=$arSection['NAME'];?></div>
                </a>
            </section>
        <?
        }
...
<?else:?>
    <div class="section-list-wrapper">
        <div class="section-list-empty">Категории отсутствуют</div>
    </div>
<?endif;?>
<?
